...
# 6. FORCE the FT.com config into BOTH locations using a Here-Doc.
#    This method prevents syntax errors with special characters.
COPY <<EOF /var/www/html/site_config/custom/ft.com.txt
http_header(User-Agent): Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0 Safari/537.36
